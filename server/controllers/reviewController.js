...
const updateReview = async (req, res, next) => {
    ...
    try {
        const reviewService = new ReviewService();
        const updatedReview = await reviewService.updateReview(email, reviewID, newReview);
        if (!updatedReview) {
...
const getReviewByPopupstore = async (req, res, next) => {
    try {
        ...
        const reviewService = new ReviewService();
        const popupStoreReview = await reviewService.getReviewByPopupstore(req.params.id, page, limit);
